...
<head>
    <meta charset="UTF-8">
    <title>Login-Koperasi Polda Kalsel</title>
    ...
    <!-- font Awesome -->
    <link href="<?php echo base_url(); ?>assets/theme_admin/css/font-awesome.min.css" rel="stylesheet"
        type="text/css" />
    <!-- Theme style -->
...
<body>
    ...
    <div class="form-box" id="login-box">
        <div class="header"><img height='80' align="center">SISTEM KOPERASI POLDA KALSEL</div>
        <form action="" method="post">
            ...
            <div class="footer">
                <div align="center">&copy; Developer by. KaryaPutraS <?php echo date('Y'); ?> </div>
            </div>
        </form>
    </div>
