...
<a href="<?php echo site_url();?>" class="logo">
			<!-- Add the class icon to your logo image or logo icon to add the margining -->
			 <div style="text-align:center;"><img height="50" src="<?php echo base_url().'assets/theme_admin/img/logo_biru.png'; ?>"></div>
		</a>
<!-- /.search form -->
...
<ul class="treeview-menu">
	...
	<?php } ?>
	<li class="<?php if ($this->uri->segment(1) == 'data_barang') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>data_barang"> <i class="fa fa-folder-open-o"></i> Jenis Pinjaman </a></li>
...
<li  class="treeview <?php 
	...
	<ul class="treeview-menu">
		...
		<li class="<?php if ($this->uri->segment(1) == 'transfer_kas') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>transfer_kas"> <i class="fa fa-folder-open-o"></i> Transfer Kas</a></li>
	</ul>
</li>
<?php } ?>
